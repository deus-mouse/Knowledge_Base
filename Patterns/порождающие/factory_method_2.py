'''
https://www.youtube.com/watch?v=Ni26lYMVM6k&t=1s

+ позволяет избежать привязки к конкеретным классам продуктов
+ выделить весь код для создания продуктов в одно место (класс, модуль)
+ упрощает добавление нового и поддержку существующего кода
