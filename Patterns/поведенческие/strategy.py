'''
https://www.youtube.com/watch?v=vnzZCfazfWw

+ избавляет от условных операторов при выборе нужного поведения
+ инкапсулирует код и данные алгоритмов для остальных классов
- усложнение кода системы за счет введения доп классов
- клиентскому коду необходимо знать о наличии различных стратегий и их особенностях
'''
